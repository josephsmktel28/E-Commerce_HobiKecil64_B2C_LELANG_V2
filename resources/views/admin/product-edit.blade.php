                                ...
                                <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.product.update')}}">
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <div class="cols gap22">
                                            ...
                                            <fieldset class="name">
                                                <div class="body-title mb-10">Auction Enabled</div>
                                                <div class="select mb-10">
                                                    <select class="" name="auction_enabled">
                                                        <option value="0" {{$product->auction_enabled == "0" ? "selected":""}}>No</option>
                                                        <option value="1" {{$product->auction_enabled == "1" ? "selected":""}}>Yes</option>
                                                    </select>
                                                </div>
                                            </fieldset>
